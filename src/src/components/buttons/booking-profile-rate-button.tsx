...
export const BookingProfileRateButton = ({booking, delivery, size, name, date, type, callBack, disableButton, bookingCancel}:ButtonType) => {
    ...
    return (
            ...
            <button data-test-id='history-review-button'
