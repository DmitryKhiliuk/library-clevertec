...
export const BookingCancelButton = ({booking, delivery, size, name, date, type, callBack, disableButton, bookingCancel}:ButtonType) => {
    ...
    return (
        <div>
            ...
            <button data-test-id='booking-cancel-button'
